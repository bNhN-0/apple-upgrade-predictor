...
def get_db():
    ...
    if not firebase_admin._apps:
        ...
        # Make sure you defined FIREBASE_SERVICE_ACCOUNT in your app's Secrets
...
# Make sure forcing_term is numeric for slider & charts
...
with tab2:
    ...
    if seg_df.empty:
        ...
        if "Upgrade Soon" in seg_stats.index and not seg_stats.loc["Upgrade Soon"].isna().all():
